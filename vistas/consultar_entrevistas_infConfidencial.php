...
?>
<header id="gtco-header" class="gtco-cover" role="banner" style="background-image: url('../librerias/Login/images/bg-06.jpg');">
          ...
          <section>
              ...
              <div class="wizard-inner" style=" padding: 3% 2%;">
                ...
                <table id="tablaEntrevistas"
                  ...
                  <thead>
                    <tr>
                      <th data-field="id_entrevista" data-visible="true">Entrevista</th>
...
<script src="../js/infConfidencial/consultar_entrevistas_infConfidencial.js"></script>
