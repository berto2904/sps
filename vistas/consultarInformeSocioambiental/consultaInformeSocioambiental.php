...
// include ($server.'/sps/controladores/consultarPostulante.php');
 ...
 ?>
	<header id="headerConsultaInfSocioambiental">
        ...
        <section>
					<div class="wizard" style=" margin: 0!important;">
						<div class="tab-content formularioPostulante">
							<?php
                include('consultarEditarInformeSocioambiental/bodyInformeSocioambiental.php');
               ?>
...
<script src="../js/infSocioambiental/consultarEditarEntrevistasInfSocioambiental.js"></script>
