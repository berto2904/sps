      ...
      <div class="col-md-6">
        ...
        <div class="row">
          ...
          <div class="col-md-3">
            ...
            <input type="number" class="form-control" id="piso" name="piso" placeholder="Piso" value="" style=" width: 5em;">
          </div>
          <div class="col-md-3">
        ...
        <?php foreach ($transportes as $key => $transporte) {?>
          <div class="row col-md-12">
            ...
            <div class="col-md-10">
              ...
              <input class="form-group"type="number" id="transporte_<?php echo $transporte['id']?>_2" name="trasporte[<?php echo $transporte['id']?>][2]" value="" style="width: 3em;">
      ...
      <div class="col-md-6">
        <div class="row">
          ...
          <div class="col-md-3">
            ...
            <input id="vivienda_ambientes" class="form-control" type="number" name="vivienda[ambientes]" value="">
          </div>
        </div>
        <div class="row">
          <div class="col-md-6">
        ...
        <div class="row">
          ...
          <div class="col-md-6">
            ...
            <div class="input-group">
              ...
              <input  id="vivienda_importe_alquiler" class="form-control" type="number" name="vivienda[importe_alquiler]" value="">
            </div>
          </div>
        </div>
      </div>
