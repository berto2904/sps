  ...
  <div class="formuInfoEconomica">
    ...
    <div class="row">
      ...
      <div class="col-md-3">
          ...
          <input type="number" class="form-control" id="" name="movilidadPropia[año]" placeholder="Año" maxlength="4" onKeyUp="if(this.value>9999){this.value='';}else if(this.value < 0){this.value=''}" onmouseup="if(this.value>9999){this.value='';}else if(this.value < 0){this.value=''}" min="0">
      </div>
    </div>
    <br>
