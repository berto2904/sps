      ...
      <div class="col-md-6">
        ...
        <div class="row">
          ...
          <div class="col-md-3">
            ...
            <input type="number" class="form-control" id="" name="piso" placeholder="Piso" value="" style=" width: 5em;" min="1">
          </div>
          <div class="col-md-3">
        ...
        <?php foreach ($transportes as $key => $transporte) {?>
          <div class="row col-md-12">
            ...
            <div class="col-md-10">
              ...
              <input class="form-group" type="number" name="trasporte[<?php echo $transporte['id']?>][2]" value="" style="width: 3em;" min="1">
      ...
      <div class="col-md-6">
        <div class="row">
          ...
          <div class="col-md-3">
            ...
            <input class="form-control" type="number" name="vivienda[ambientes]" value="" min="1">
          </div>
        </div>
        <div class="row">
          <div class="col-md-6">
        ...
        <div class="row">
          ...
          <div class="col-md-6">
            ...
            <div class="input-group">
              ...
              <input class="form-control" type="number" name="vivienda[importe_alquiler]" value="" min="1">
            </div>
          </div>
        </div>
      </div>
